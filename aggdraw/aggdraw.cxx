...
static PyObject* draw_path(DrawObject* self, PyObject* args, PyObject* keywds){
  PathObject* path;
  PyObject*   brush = NULL;
  PyObject*   pen   = NULL;

  char *kwlist[] = {"pen", "brush", NULL};

  if (!PyArg_ParseTupleAndKeywords(args, keywds, "O!|OO", kwlist, &PathType, &path, &brush, &pen)){
    return NULL;
  }
...
static PyObject*
path_bounds(PathObject* self, PyObject* args)
{
...
static PyMethodDef path_methods[] = {
    ...
    {"bounds", (PyCFunction) path_bounds, METH_VARARGS},
